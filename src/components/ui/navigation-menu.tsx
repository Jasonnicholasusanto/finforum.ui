  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        header:
          "hover:bg-transparent hover:text-foreground hover:font-semibold\
          focus:bg-transparent focus:font-semibold focus:text-foreground\
          data-[state=open]:bg-transparent data-[state=open]:font-semibold data-[state=open]:text-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
